/**
 * Main jQuery media file for adding documents to HEART records - pastes attachment url into custom "document url" field
 *
 */
jQuery(document).ready(function($){
    // Prepare the variable that holds our custom media manager.
    var heart_media_frame;
    
    // Bind to our click event in order to open up the new media experience.
    $(document.body).on('click.heartOpenMediaManager', '.insert-document', function(e){
        // Prevent the default action from occuring.
        e.preventDefault();

        // If the frame already exists, re-open it.
        if ( heart_media_frame ) {
            heart_media_frame.open();
            return;
        }
         ...
         */
        heart_media_frame = wp.media.frames.heart_media_frame = wp.media({
            /**
             ...
             */
            className: 'media-frame heart-media-frame',
             ...
             * the script with the object 'heart_nmp_media' that holds our
             * localized stuff and such. Let's populate the title with our custom
             * text.
             */
            title: heart_document_media.title,
             ...
             */
            button: {
                text:  heart_document_media.button
            }
        });
		 ...
		 *
		 * Media attachment url added to custom acf-field-document_url field (Document URL custom field)
         */
        heart_media_frame.on('select', function(){
            // Grab our attachment selection and construct a JSON representation of the model.
            var media_attachment = heart_media_frame.state().get('selection').first().toJSON();

            // Send the attachment URL to our custom input field via jQuery.
            $('#acf-field-external_url').val(media_attachment.url);
			$('#acf-field-file_size').val(media_attachment.filesize);
        });
