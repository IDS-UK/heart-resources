...
?>
<div id="comments">
	<div id="comments-reveal"><h2 class="interested-title">Comments<?php if (get_comments_number() > 0) {echo ' (' . get_comments_number() . ')';}?></h2><i class="fa fa-2x fa-plus"></i></div>

		<div id="comments-block" class="comments-area" style="display: none;">

			<?php if ( have_comments() ) : ?>
				<h3 class="comments-title">
					<?php
						printf( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'colormag' ),
			...
			<?php 
				$comments_args = array(
				        ...
				        'comment_field' => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label><br /><textarea id="comment" name="comment" cols="140" rows="8" maxlength="65525" aria-required="true" required="required"></textarea></p>',
				);
